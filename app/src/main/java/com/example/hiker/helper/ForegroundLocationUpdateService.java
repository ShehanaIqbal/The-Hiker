...
import com.example.hiker.StartHikeActivity;
...
public class ForegroundLocationUpdateService extends  Service {
    ...
    private static final String TAG = ForegroundLocationUpdateService.class.getSimpleName();
    ...
    public ForegroundLocationUpdateService() {
    }
    ...
    public class LocalBinder extends Binder {
        public ForegroundLocationUpdateService getService() {
            return ForegroundLocationUpdateService.this;
        }
    }
    ...
    public void requestLocationUpdates() {
        ...
        startService(new Intent(getApplicationContext(), ForegroundLocationUpdateService.class));
        try {
    ...
    private Notification getNotification() {
        Intent intent = new Intent(this, ForegroundLocationUpdateService.class);
        ...
        PendingIntent activityPendingIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, StartHikeActivity.class), 0);
